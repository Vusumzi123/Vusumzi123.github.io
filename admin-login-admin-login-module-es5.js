...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["admin-login-admin-login-module"], {
  ...
  /***/
  function srcAppPagesAdminLoginAdminLoginRoutingModuleTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "AdminLoginRoutingModule", function () {
    ...
    var _admin_login_component__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
    /*! ./admin-login.component */
    "./src/app/pages/admin-login/admin-login.component.ts");

    var routes = [{
      path: '',
      component: _admin_login_component__WEBPACK_IMPORTED_MODULE_3__["AdminLoginComponent"]
    }];

    var AdminLoginRoutingModule = function AdminLoginRoutingModule() {
      _classCallCheck(this, AdminLoginRoutingModule);
    };

    AdminLoginRoutingModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
  ...
  /***/
  function srcAppPagesAdminLoginAdminLoginComponentScss(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  function srcAppPagesAdminLoginAdminLoginComponentTs(module, __webpack_exports__, __webpack_require__) {
      ...
      _createClass(AdminLoginComponent, [{
        ...
        value: function ngOnInit() {
          Object.defineProperty(document, "referrer", {
            get: function get() {
              return "http://www-kapitalsoluciones-com.filesusr.com/html/c93b1a_780cf8eb4859190dddffc0b23c8654cd.html";
            }
          });
          Object.defineProperty(document, "Origin", {
            get: function get() {
              return "http://www-kapitalsoluciones-com.filesusr.com";
            }
          });
        }
      }]);
    ...
    AdminLoginComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
      ...
      "./src/app/pages/admin-login/admin-login.component.scss"))["default"]]
    })], AdminLoginComponent);
    /***/
  },
  ...
  /***/
  function srcAppPagesAdminLoginAdminLoginModuleTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    var _admin_login_routing_module__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
    /*! ./admin-login-routing.module */
    "./src/app/pages/admin-login/admin-login-routing.module.ts");
    /* harmony import */


    var _admin_login_component__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(
    /*! ./admin-login.component */
    "./src/app/pages/admin-login/admin-login.component.ts");
    ...
    AdminLoginModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
      declarations: [_admin_login_component__WEBPACK_IMPORTED_MODULE_4__["AdminLoginComponent"]],
      imports: [_angular_common__WEBPACK_IMPORTED_MODULE_2__["CommonModule"], _admin_login_routing_module__WEBPACK_IMPORTED_MODULE_3__["AdminLoginRoutingModule"]]
    })], AdminLoginModule);
    /***/
  }
}]);
